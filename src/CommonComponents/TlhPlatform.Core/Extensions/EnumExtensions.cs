...
namespace TlhPlatform.Core.Extensions
{
    ...
    public static class EnumExtensions
    {
        ...
        {
            return Reflection.Reflection.GetDescription<TEnum>(GetName<TEnum>(member));
        }
        ...
        {
            return Reflection.Reflection.GetDescription(type, GetName(type, member));
        }
        ...
        private static void AddItem(Type type, ICollection<Item> result, FieldInfo field)
        {
            ...
            var description = Reflection.Reflection.GetDescription(field);
