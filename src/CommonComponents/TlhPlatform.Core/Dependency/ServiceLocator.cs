...
{ 
    ...
    public sealed class ServiceLocator : IDisposable
    {
        ...
        public void ExcuteScopedWork(Action<IServiceProvider> action)
        {
            if (_provider == null)
            {
                throw new VOCsException("Root级别的IServiceProvider不存在，无法执行Scoped业务");
            }
        ...
        {
            Microsoft.Extensions.Logging.ILoggerFactory factory = GetService<Microsoft.Extensions.Logging.ILoggerFactory>();
        ...
        {
            Microsoft.Extensions.Configuration.IConfiguration config = GetService<Microsoft.Extensions.Configuration.IConfiguration>() ?? Singleton<Microsoft.Extensions.Configuration.IConfiguration>.Instance;
            return config?[path];
        }
