// -----------------------------------------------------------------------
//  <copyright file="CollectionPropertySorter.cs" company="TlhPlatform.Core开源团队">
//      Copyright (c) 2014-2015 TlhPlatform.Core. All rights reserved.
//  </copyright>
    ...
    public static class CollectionPropertySorter<T>
    {
        ...
        private static LambdaExpression GetKeySelector(string keyName)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new VOCsException(string.Format(Resources.ObjectExtensions_PropertyNameNotExistsInType, propertyName));
                }
