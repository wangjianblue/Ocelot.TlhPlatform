...
namespace TlhPlatform.Core.Reflection.Finders
{
    ...
    public abstract class FinderBase<TItem> : Finders<TItem>
    {
        ...
        /// <summary>Gets or sets wether Carrefour should iterate assemblies in the app domain when loading Carrefour types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Carrefour assemblies arn't investigated (e.g. by not including something like "^Carrefour|..." you may break core functionality.</remarks>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Carrefour.
        /// </returns>
